...
public class pagos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablac.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pago", "ID Membresia", "Fecha", "Total"
            }
        ) {
        ...
        jLabel1.setText("pagos de membresias");
    ...
    private void buscar(){
        try{
            ...
            String sql="SELECT * FROM pago where id_membresia='"+bust.getText()+"' or idpago='"+bust.getText()+"' or fecha='"+bust.getText()+"'";
            ps=con.prepareStatement(sql);
            rs=ps.executeQuery();
            ResultSetMetaData rsmd=rs.getMetaData();
            int cantcol=rsmd.getColumnCount();
