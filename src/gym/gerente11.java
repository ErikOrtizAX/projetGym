 ...
 * @author Erik
 */
public class gerente11 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gerente11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
